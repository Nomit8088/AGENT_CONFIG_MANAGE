<template>
  ...
  >
    <div class="bg-white dark:bg-[#121316] w-full max-w-4xl rounded-xl p-6 border border-black/10 dark:border-white/12 shadow-2xl dark:shadow-none flex flex-col max-h-[90vh] text-slate-900 dark:text-white transition-colors duration-200">
      <!-- Modal Header -->
      ...
      <div class="flex-1 overflow-hidden py-4 grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="flex flex-col rounded-xl border border-black/8 dark:border-white/8 bg-black/[0.02] dark:bg-[#1c1d22] overflow-hidden">
          <div class="px-3 py-2 border-b border-black/8 dark:border-white/8 bg-black/[0.02] dark:bg-[#121316] flex items-center justify-between text-xs">
